...
{
    public class LocalDataSourceController : Controller
    {
        private LocalDataSourceContext db = new LocalDataSourceContext();

        //public const string search_index_name = "marvel";

        //public const string admin_key = "587E6E4A328554F23409BF59C2A7781D";
        //public const string query_key = "BA3FEF77DE33D8CDA517DE2EF2CECB15";

        //private Microsoft.Azure.Search.SearchServiceClient adminService = new Microsoft.Azure.Search.SearchServiceClient("codecamp", new Microsoft.Azure.Search.SearchCredentials(admin_key));

        //private Microsoft.Azure.Search.SearchIndexClient adminIndex = new Microsoft.Azure.Search.SearchIndexClient("codecamp", search_index_name, new Microsoft.Azure.Search.SearchCredentials(admin_key));

        //private Microsoft.Azure.Search.SearchIndexClient queryIndex = new Microsoft.Azure.Search.SearchIndexClient("codecamp", search_index_name, new Microsoft.Azure.Search.SearchCredentials(query_key));
        ...
        public ViewResult Index(string sortOrder, string currentFilter, int? page)
        {
            ...
            var heroes = from s in db.MarvelSuperHeroes
                         select s;
            switch (sortOrder)
            {
        ...
        public ActionResult Edit(string SuperHeroModelID)
        {
            ...
            SuperHeroModel hero = db.MarvelSuperHeroes.Find(SuperHeroModelID);
            if (hero == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult EditPost(string SuperHeroModelID)
        {
            ...
            var heroToUpdate = db.MarvelSuperHeroes.Find(SuperHeroModelID);
        ...
        public ActionResult Delete(string SuperHeroModelID)
        {
            ...
            {
                SuperHeroModel hero = db.MarvelSuperHeroes.Find(SuperHeroModelID);
                db.MarvelSuperHeroes.Remove(hero);
                db.SaveChanges();
